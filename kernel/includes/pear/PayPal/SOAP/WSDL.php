...
class SOAP_WSDL_Parser extends SOAP_Base
{
    ...
    public $schema = '';
    public $schemaStatus = '';
    public $schema_stack = array();
    public $currentComplexType;
    public $schema_element_stack = array();
