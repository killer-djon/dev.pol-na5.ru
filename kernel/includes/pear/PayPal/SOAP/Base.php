...
class SOAP_Base_Object extends PEAR
{
     ...
     */
    public $_encodings = array('ISO-8859-1', 'US-ASCII', 'UTF-8');
...
{
    public $_XMLSchema = array('http://www.w3.org/2001/XMLSchema', 'http://www.w3.org/1999/XMLSchema');
    ...
    public $_xmlEntities = array('&' => '&amp;', '<' => '&lt;', '>' => '&gt;', "'" => '&apos;', '"' => '&quot;');

    public $_doconversion = false;

    public $__attachments = array();
    ...
    public $_type_translation = array();
