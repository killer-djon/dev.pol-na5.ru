<?php
	...
	// Tips and Tricks
	//
	define( 'WBS_TT_ENDPOINT', "/wbs/QP/soap/qp_webservice.php?DB_KEY=webasyst" );
	define( 'WBS_TT_IMG_PATH', ":/wbs/publicdata/WEBASYST/attachments/qp/attachments/" );
	...
	//
	define('URL_UPGRADE_HELP', '#hosted-accounts.htm');
	define('URL_REGISTER_HELP', '#hosted-accounts.htm');
