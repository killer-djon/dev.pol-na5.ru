...
$.widget("ui.wbsPopup", {
	...
	_create: function() {
		...
		if (o.shadow) this.element.addClass("ui-wbs-shadow"+o.shadow_prefix[0] );
	...
	open: function(el){
		...
		if (o.closed) {
			...
			if (o.parentShadow) o.parent.addClass("ui-wbs-shadow"+o.shadow_prefix[1]);
			o.closed = false;
			o.open(el);
		} else {
			this.close();
	...
	close: function(){
		...
		if (o.parentShadow) o.parent.removeClass("ui-wbs-shadow"+o.shadow_prefix[1]);
		o.closed = true;
		o.close();
	}
});
