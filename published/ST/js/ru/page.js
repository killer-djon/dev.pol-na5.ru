var Page = function (config) {
	...
	this.loading = function () {
		$("#body").html('<div class="loading">Загрузка... <span>&nbsp;</span></div>');
	};
...
var Requests = function (config) {
	...
	this.render = function (data) {
		...
		'<tr style="height:25px"><th class="first">ID</th><th>Источник</th><th>Дата</th><th>Клиент</th><th width="100%">Тема</th><th>Статус</th><th nowrap>Назначенный пользователь</th></tr>' + 
		'</thead><tbody>' + 
