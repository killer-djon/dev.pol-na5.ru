...
//	var $language = 'eng';
	var $default_logo = './images_common/payment-icons/ing.gif';
	...
	function __hash($data, $prd_num){
		...
		$concatStr = html_entity_decode($concatStr,ENT_QUOTES,'utf-8');
	    $not_allowed = array("\t", "\n", "\r", " ");
	...
	function after_processing_html( $orderID, $active = true  ) 
	{
		...
		$post_fields['hash'] = $this->__hash($post_fields, $count);
