...
define('LIQPAY_CFG_ORDER_PREFIX_TTL','Префикс счета');
define('LIQPAY_CFG_ORDER_PREFIX_DSCR','Используйте цифры и латинские буквы для ввода префикса номера счета в системе LiqPay');
define('LIQPAY_CFG_BUGFIX_TTL','Добавлять случайное число к номеру счета');
define('LIQPAY_CFG_BUGFIX_DSCR','Позволяет избежать ошибку нарушения уникальности Order ID платежной системы LiqPay при повторных оплатах счета');
...
define('LIQPAY_TXT_PROCESS','Оплатить через LiqPay сейчас!');
