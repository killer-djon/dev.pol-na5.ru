...
class YandexCPP extends PaymentModule
{
	...
	var $language = 'rus';
	var $default_logo = './images_common/payment-icons/yandexmoney.gif';
	/*
...
';
	...
	function transactionResultHandler($transaction_result = '',$message = '',$source = 'frontend')
	{
		if($source != 'handler'){
			...
			try{
				...
				$order = new Order();
				$orderID = Env::Post('CustomerNumber',Env::TYPE_INT,Env::Post('customerNumber',Env::TYPE_INT,0));
	 ...
	 * @return boolean
	 */
	private function verifyHash($orderID)
	{
