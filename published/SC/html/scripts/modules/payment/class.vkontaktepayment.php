...
class VKontaktePayment extends PaymentModule
{
	...
	function _initVars()
	{
		...
		$this->description 	= "Экспорт продуктов в каталог «Вконтакта» и возможность покупки прямо из сети. Инструкции по подключению: <a href='http://support/help/shop-script-vkontakte-integration.html' target='_blank'>http://support/help/shop-script-vkontakte-integration.html</a>";
		$this->sort_order 	= 0;
		$this->Settings = array(
