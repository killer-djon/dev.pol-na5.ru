...
define('FEDEXSHIPPINGMODULE_DSCR', 
	'FedEx Ship Manager Direct. Real-time shipping rate calculations.<br>Your need to have an account with FedEx to make this module work.<br />Please read our <a href="/help/setup-shipping-quotes-fedex.htm" target="_blank">detailed description on how to setup FedEx real-time shipping quotes</a>.');
