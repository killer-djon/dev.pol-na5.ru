...
define('SHIPPING_MODULE_USPS_DSCR','USPS Web Tools. Real-time shipping rates calculations.<br>Your need to have an account with www.usps.com to make this module work.<br />Please read our <a href="/help/setup-shipping-quotes-usps.htm" target="_blank">detailed description on how to setup USPS real-time shipping quotes</a>.');
