<?php
	...
	define('DHLSHIPPINGMODULE_DSCR', 'DHL Airborne. Real-time shipping rate calculations.<br>Your need to have an account with DHL to make this module work.<br />Please read our <a href="/help/setup-shipping-quotes-dhl.htm" target="_blank">detailed description on how to setup DHL real-time shipping quotes</a>.');
