...
define('UPSSHIPPINGMODULE_DSCR',
	'UPS OnLine Tools. Real-time shipping rate calculations.<br>Your need to have an account with www.ups.com to make this module work.<br />Please read our <a href="/help/setup-shipping-quotes-ups.htm" target="_blank">detailed description on how to setup UPS real-time shipping quotes</a>.');
