...
class fedexShippingModule extends ShippingRateCalculator{
	...
	var $default_logo = 'http://www./collections/design/shipping-icons/fedex.gif';
	...
	function _sendXMLQuery($_Data){
		...
		if($this->_getSettingValue('CONF_SHIPPING_FEDEX_ENABLE_ERROR_LOG') ){
			$this->_writeLogMessage(0,var_export(array('POST'=>$_Data,'response'=>$result),true));
		}
		return $result;
	}
