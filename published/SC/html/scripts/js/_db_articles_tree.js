      ...
      req.onreadystatechange = function() {
          ...
          if (req.readyState == 4) { 
            ...
            for(var _d=0,max_d = categories.length; _d<max_d; _d++){
            		...
            		EvalStr += "window._nd_"+categories[_d]['CategoryID']+" = _nd_"+categories[_d]['CategoryParent']+".addChildNode({'id':'_nd_"+categories[_d]['CategoryID']+"','name':'"+categories[_d]['CategoryTitle']+"','categoryID':'"+categories[_d]['CategoryID']+"','Expanded':true,'isParent':"+(categories[_d]['ExistSubCategories']?'true':'false')+"});\n";
