...
define('ARTICLES_TABLE',  DBTABLE_PREFIX.'articles');
define('ARTICLES_CATEGORY_TABLE', DBTABLE_PREFIX.'category_articles');
define('ARTICLES_COMMENTS_TABLE', DBTABLE_PREFIX.'articles_comments');
?>