	...
	class LanguagesManager{
		...
		function LanguagesManager(){
			...
			$this->ml_tables = array(
				...
				ARTICLES_CATEGORY_TABLE => array(
					'CategoryTitle','CategoryDescription','CategoryMetaTitle','CategoryMetaKey','CategoryMetaDescription'
				),
				ARTICLES_TABLE => array(
					'ArticleTitle','ArticleBriefDescription','ArticleDescription','ArticleAuthor','ArticleMetaTitle','ArticleMetaKey','ArticleMetaDescription'
				),
				NEWS_TABLE => array(
