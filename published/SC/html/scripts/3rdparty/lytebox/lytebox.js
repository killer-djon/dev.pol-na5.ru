...
function Lytebox(bInitialize, aHttp) {
	...
	/*** Configure HTML Content / Media Viewer Options ***/
		...
		this.__width			= '100%';		// default width of content viewer
		this.__height			= '100%';		// default height of content viewer
	...
	/*** Configure Slideshow Options ***/
		...
		this.__slideInterval	= 2000;			// change value (milliseconds) to increase/decrease the time between "slides"
