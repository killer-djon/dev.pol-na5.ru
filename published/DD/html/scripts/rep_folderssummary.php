<?php
	...
	switch (true) {
		case true :
			...
			$totals = null;
			$reportData = dd_repFoldesSummary( $kernelStrings, $totals );
	...
	$preproc->assign( PAGE_TITLE, $ddStrings['rep_folderssummary_title'] );
	$preproc->assign( FORM_LINK, PAGE_DD_REP_FOLDERSSUMMARY );
	...
	$preproc->display( "rep_folderssummary.htm" );
?>