...
if(!defined('WA_ENV_WEB_VERSION_FILENAME')){
	define('WA_ENV_WEB_VERSION_FILENAME','http://my./cc/version.xml');
}
if(!defined('WA_ENV_WEB_CHANGE_FILENAME')){
	define('WA_ENV_WEB_CHANGE_FILENAME','http://my./cc/changelog.xml');
}
if(!defined('WA_ENV_WEB_URL')){
	define('WA_ENV_WEB_URL','my.');
}
...
class DiagnosticTests
{
	...
	function my_testPHP()
	{
		...
		$res = (version_compare(PHP_VERSION,'5.0.5', '>=')?1:0),
